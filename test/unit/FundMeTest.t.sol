...
contract FundMeTest is Test {
    ...
    function testOwnerIsMsgSender() public view {
        //fundMe是由FundMeTest创建出来的，所以FundMeTest是fundMe的owner
        console.log(fundMe.getOwner());
        console.log(address(this));
        assertEq(fundMe.getOwner(), msg.sender);
    }

    function testPrieFeedVersionIsAccurate() public view {
        //
    ...
    function testOnlyOwnerCanDraw() public funded {
        vm.prank(USER);
        vm.expectRevert();
        fundMe.withdraw();
    }
